...
export class ContracteventAddDistributorProduct extends ethereum.Event {
  get params(): ContracteventAddDistributorProduct__Params {
    return new ContracteventAddDistributorProduct__Params(this);
  }
}

export class ContracteventAddDistributorProduct__Params {
  _event: ContracteventAddDistributorProduct;

  constructor(event: ContracteventAddDistributorProduct) {
    this._event = event;
  }
...
export class ContracteventDeleteDistributorProduct extends ethereum.Event {
  get params(): ContracteventDeleteDistributorProduct__Params {
    return new ContracteventDeleteDistributorProduct__Params(this);
  }
}

export class ContracteventDeleteDistributorProduct__Params {
  _event: ContracteventDeleteDistributorProduct;

  constructor(event: ContracteventDeleteDistributorProduct) {
    this._event = event;
  }
...
export class ContracteventUpdateDistributorProductUints extends ethereum.Event {
  get params(): ContracteventUpdateDistributorProductUints__Params {
    return new ContracteventUpdateDistributorProductUints__Params(this);
  }
}

export class ContracteventUpdateDistributorProductUints__Params {
  _event: ContracteventUpdateDistributorProductUints;

  constructor(event: ContracteventUpdateDistributorProductUints) {
    this._event = event;
  }
...
export class Contract__distributorProductsIdToStructMappingResult {
  value0: Bytes;
  value1: Bytes;
  value2: BigInt;
  value3: BigInt;
...
export class Contract__getAllProductsOfDistributorResultValue0Struct extends ethereum.Tuple {
...
export class Contract__getSingleDistributorProductResultValue0Struct extends ethereum.Tuple {
  get manufacturerAddress(): Array<Address> {
    return this[0].toAddressArray();
  }
...
export class Contract extends ethereum.SmartContract {
  ...
  distributorProductsIdToStructMapping(
    param0: BigInt
  ): Contract__distributorProductsIdToStructMappingResult {
    let result = super.call(
      "distributorProductsIdToStructMapping",
    ...
    return new Contract__distributorProductsIdToStructMappingResult(
      result[0].toBytes(),
      result[1].toBytes(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_distributorProductsIdToStructMapping(
    param0: BigInt
  ): ethereum.CallResult<Contract__distributorProductsIdToStructMappingResult> {
    let result = super.tryCall(
      "distributorProductsIdToStructMapping",
      "distributorProductsIdToStructMapping(uint256):(bytes,bytes,uint128,uint128,uint32,uint32,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new Contract__distributorProductsIdToStructMappingResult(
        value[0].toBytes(),
        value[1].toBytes(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getAllProductsOfDistributor(
  ...
  ): Array<Contract__getAllProductsOfDistributorResultValue0Struct> {
    let result = super.call(
      "getAllProductsOfDistributor",
    ...
    return result[0].toTupleArray<
      Contract__getAllProductsOfDistributorResultValue0Struct
    >();
  }
  ...
  getSingleDistributorProduct(
    _id: BigInt
  ): Contract__getSingleDistributorProductResultValue0Struct {
    let result = super.call(
      "getSingleDistributorProduct",
    ...
    return changetype<Contract__getSingleDistributorProductResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Contract__getSingleDistributorProductResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
